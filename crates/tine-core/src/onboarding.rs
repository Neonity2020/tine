...
mod tests {
    ...
    fn find_revisit_workflow_is_registered_linked_and_copyable() {
        ...
        assert!(page.markdown.contains("type **/query** and choose **Query**"));
        ...
        assert!(page.markdown.contains("A hand-written advanced query stays editable as text"));
    ...
    fn pages_links_search_reference_is_registered_linked_and_copyable() {
        ...
        assert!(page.markdown.contains("every page with at least one `tags::` value"));
        assert!(page.markdown.contains("Unlinked References header identifies that waiting state"));
    ...
    fn research_document_workflow_is_registered_linked_and_copyable() {
        ...
        assert!(page.markdown.contains("A query about pages cannot currently be included"));
        assert!(page.markdown.contains("Starting another **Export to PDF…** or switching graphs"));
        assert!(page
            .markdown
