//! Authoritative names for managed-storage files and directories.
//!
//! These names describe layout only. Authority and lifecycle are documented in
//! `docs/storage-sync-contract.md`. Schema/magic constants stay with their
//! codecs; the pinned `tine-storage::formats` module owns scratch and SQLite
//! schema versions.
...
// App-private binding and recovery roots (Tauri shell).
...
pub const PROJECTION_CLEANUP_ROUND_DIRS: [&str; 2] = ["round-0", "round-1"];
