...
// `published-queries/<name>/` through the real Tauri command route (Direct
// Files by default; `E2E_PUBLISH_QUERY_MANAGED=1` activates Tine-managed
// storage first so the actor turn is the path exercised).
...
const managed = process.env.E2E_PUBLISH_QUERY_MANAGED === "1";
...
try {
  ...
  const report = { app, managed, out, files, listed };
