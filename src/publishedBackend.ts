...
export function publishedBackend(load: () => Promise<PublishedSnapshot> = loadPublishedSnapshot): Backend {
  ...
  const constant = {
    ...
    onSparseV2Status: unsubscribed,
    onSparseV2Tick: unsubscribed,
    onSparseV2Error: unsubscribed,
    onSparseV2ActivationProgress: unsubscribed,
    onAbsenceSweepChanged: unsubscribed,
    ...
    onSparseV2Changed: unsubscribed,
    onManagedSyncError: unsubscribed,
