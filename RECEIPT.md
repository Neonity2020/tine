...
first source edit (it had only renamed the repro receipt to RECEIPT-repro.md).
...
findings: RECEIPT-repro.md (same directory).
...
RECEIPT-repro.md §10; serial `--exact --test-threads=1` rerun: ok (0.20s).
Zero new red.
