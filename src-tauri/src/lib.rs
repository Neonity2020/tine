...
use commands::{
    ...
    list_pages, list_sync_conflicts, list_templates, list_vcs_marker_conflicts,
    load_workspaces, merge_pages,
    ...
    resolve_block, resolve_blocks, resolve_sync_conflict, retire_editor_activation,
