...
use commands::{
    ...
    capture_quick_switch, close_graph_window, conflict_queue, copy_guide_into_graph, delete_page,
    ...
    list_pages, list_sync_conflicts, list_templates, list_vcs_marker_conflicts, load_workspaces,
